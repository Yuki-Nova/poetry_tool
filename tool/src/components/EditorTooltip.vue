    ...
    <div v-if="visible" class="editor-tooltip" :style="tooltipStyle">
      ...
      <template v-if="multiToneCandidates?.length">
        ...
        <div class="et-candidates">
          <div class="et-sub-title">候选读音</div>
          <div v-for="(c, i) in multiToneCandidates" :key="i" class="et-candidate">
...
.et-candidate { display: flex; align-items: center; gap: 8px; padding: 2px 0; font-size: 12px; }
